      ...
      {filteredGames.length > 0 ? (
        <>
          <div className="w-full">
            <PlayerRatingChart games={filteredGames} />
          </div>
          <CommonOpponentsTable games={filteredGames} />
        ...
        <div className="text-gray-500">No valid games found for this player code.</div>
      )}
    </div>
  )
}
